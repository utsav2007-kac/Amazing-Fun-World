...
(function () {
  const FOOTER_HTML = `
  <footer class="bg-inverse-surface text-surface-container-lowest py-section-gap-mobile md:py-section-gap-desktop">
    <div class="max-w-container-max mx-auto px-gutter grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12">
      <!-- Brand -->
      <div class="space-y-6">
